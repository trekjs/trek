...
var Engine = (function (_Koa) {
  ...
  Engine.prototype.serveFile = function serveFile(path, file, options) {
    ...
    this.get(path, _koaStatic2['default'](dir, options));
  };
  ...
  Engine.prototype.match = function match(methods, path) {
    for (var _len3 = arguments.length, handler = Array(_len3 > 2 ? _len3 - 2 : 0), _key3 = 2; _key3 < _len3; _key3++) {
      handler[_key3 - 2] = arguments[_key3];
    }
  ...
  Engine.prototype.all = function all(path) {
    for (var _len4 = arguments.length, handler = Array(_len4 > 1 ? _len4 - 1 : 0), _key4 = 1; _key4 < _len4; _key4++) {
      handler[_key4 - 1] = arguments[_key4];
    }
