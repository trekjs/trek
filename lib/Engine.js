...
var Engine = (function (_Koa) {
  ...
  Engine.prototype.loadServices = function loadServices() {
    ...
    return _co2['default'](regeneratorRuntime.mark(function callee$2$0() {
      var seq, _iterator, _isArray, _i, _ref, file, _name, service;
      ...
      return regeneratorRuntime.wrap(function callee$2$0$(context$3$0) {
        while (1) switch (context$3$0.prev = context$3$0.next) {
          ...
          case 12:
            file = _ref;
            _name = _path.basename(file, '.js').replace(/^[0-9]+-/, '');
            service = require(this.rootPath + '/' + file)(this, this.config);
  ...
  Engine.prototype.listen = function listen() {
    ...
    this.loadStack();
    this.loadRoutes();
    this.use(regeneratorRuntime.mark(function dispatcher(next) {
      var _app$router$find, handler, params;

      return regeneratorRuntime.wrap(function dispatcher$(context$3$0) {
        var _this2 = this;

        while (1) switch (context$3$0.prev = context$3$0.next) {
          case 0:
            this.params = Object.create(null);
            _app$router$find = this.app.router.find(this.method, this.path);
            handler = _app$router$find[0];
            params = _app$router$find[1];
            ...
            return context$3$0.delegateYield(handler.call(this, next), 't0', 7);
