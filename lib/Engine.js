...
var Engine = (function (_Koa) {
  ...
  Engine.prototype.match = function match(methods, path) {
    for (var _len4 = arguments.length, handler = Array(_len4 > 2 ? _len4 - 2 : 0), _key4 = 2; _key4 < _len4; _key4++) {
      handler[_key4 - 2] = arguments[_key4];
    }
    ...
    methods.forEach(function (m) {
      if (METHODS.includes(m)) {
        var v = m.replace('-', '');
        _this5[v].apply(_this5, [path].concat(handler));
      }
    });
  };
