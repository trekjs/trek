...
if (!has(global, "Trek")) {
   ...
   */
  delegate(Trek, "King").getter("_").getter("joi").getter("jwt").getter("uuid").getter("bcrypt").getter("pbkdf2").getter("logger").getter("validator").getter("Mailer").getter("dotenv").getter("debug");
}
