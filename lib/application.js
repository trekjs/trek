...
var Application = (function (Engine) {
  ...
  _prototypeProperties(Application, null, {
    ...
    envConfig: {
      get: function () {
        return this._appEnvConfig || (this.validateSecretKeyConfig(), this._appEnvConfig = Object.assign({}, _get(Object.getPrototypeOf(Application.prototype), "envConfig", this), {
    ...
    secrets: {
      get: function () {
        ...
        return this._secrets || (this._secrets = (function () {
          ...
          if (!_hasOwn.call(secrets, "secretKeyBase")) secrets.secretKeyBase = _this.config.secretKeyBase;
