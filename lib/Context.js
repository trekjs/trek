...
class Context {
  ...
  *sendFile(path) {
    ...
    if (opts.disposition) {
      var filename = opts.filename || (0, _path.basename)(path);
      this.attachment(filename);
    }

    yield (0, _koaSend2.default)(this, path, options);
  }
   ...
   */
  jsonp(obj) {
    let name = arguments.length <= 1 || arguments[1] === undefined ? 'callback' : arguments[1];
...
exports.default = Context; // Sets Context's prototype to originalContext `koa/context`.

Object.setPrototypeOf(Context.prototype, _context2.default);